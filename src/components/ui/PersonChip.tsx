...
export function PersonChip({ name, selected, onToggle, anonymous = false }: PersonChipProps) {
  return (
    <button
      ...
      className={`inline-flex min-h-11 items-center gap-1.5 rounded-full border-2 px-3.5 py-1.5 text-sm font-medium transition focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-forest ${
        selected
