...
export function ReceiptLineItem({ item, index, people, isEditing, onEdit, onRemove }: ReceiptLineItemProps) {
  ...
  return (
    <Reorder.Item
      ...
      className={`flex items-start gap-2 rounded-md bg-surface text-sm ${
        isEditing ? "ring-2 ring-brass" : ""
      }`}
    >
      <button
        type="button"
